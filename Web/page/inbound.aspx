<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inbound.aspx.cs" Inherits="Web.page.inbound" %>
	...
	<body>
        ...
        <script type ="text/javascript">
            ...
            function jiansuo()
            {
                ...
                window.location.href = "inbound.aspx?act=Jiansuo&orderid=" + orderid + "&spname=" + spname + "&splb=" + splb;
