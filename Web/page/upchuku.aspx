<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upchuku.aspx.cs" Inherits="Web.page.upchuku" %>
...
<%--							<li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;">入库记录</li>--%>
							 <li class="" style="box-sizing: initial;-webkit-box-sizing: initial;">修改出库</li>
						</ul>
					</div>
				<%--	<div class="bd">
