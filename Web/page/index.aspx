<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Web.page.index" %>
...
<html>
	...
	<head>
		...
		<style type="text/css">
			...
			.headeruserface {
				background-image: url('page/Resources/images/logo.png');
				width: 40px;
				height: 40px;
				background-color: white;
	...
	<body>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="type.aspx" target="right">
							<li>基础资料设定</li>
						</a>
						<a href="inventory.aspx" target="right">
							<li>出库管理</li>
						</a>
						<a href="inbound.aspx" target="right">
							<li>入库管理</li>
						</a>
						<a href="warning.aspx" target="right">
							<li>明细</li>
						</a>
						<a href="outBoud.aspx" target="right">
							<li>库存管理</li>
						</a>
						<a href="user.aspx" target="right">
							<li>进销存</li>
						</a>
						<a href="updatePwd.aspx" target="right"><li >期初</li></a>
                        <a href="JiaGongShangpin.aspx" target="right">
							<li>销售商品</li>
						</a>
                        <a href="YongLiaoJiChu.aspx" target="right">
							<li>用料基础设定</li>
						</a>
					</ul>
				</li>
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="inbound.aspx" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
