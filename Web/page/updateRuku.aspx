<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateRuku.aspx.cs" Inherits="Web.page.update" %>
        ...
        <script type ="text/javascript">
            function queren(Type) {
                ...
                if (!confirm("确认提交吗？")) {
                    ...
                    var url = "";
                    var spid = $("#spid").val();
                    url = "inbound.aspx?id="+spid+"&shijian=" + shijian + "&orderid=" + orderid + "&act=update&fl=" + fenlei + "&name=" + name + "&sl=" + shuliang + "&dj=" + dj + "&bz=" + bz;
...
<%--							<li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;">入库记录</li>--%>
							 <li class="" style="box-sizing: initial;-webkit-box-sizing: initial;">修改入库</li>
						</ul>
					</div>
				<%--	<div class="bd">
						...
						<form id="Form1" class="am-form am-form-horizontal"
						    ...
						    <div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<asp:TextBox   ID="orderid" required
										...
										<small id="oid" runat="server">订单编号</small>
								</div>
							</div>
							<div class="am-form-group">
							...
							供货方</label>
								<div class="am-u-sm-9">
                                    ...
                                    <small id="ghf" runat="server">供货方</small>
								</div>
							</div>
