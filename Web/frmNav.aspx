    ...
    <form id="form1" runat="server">
        ...
        <div class="header_login_info">
            <div class="header_login_info_con">
                ...
                <span class="fl welcome_info" style="font-size: 13px">你好         ！　　你的账号：<%=Session["username"] %></span>
                ...
                <span id="myspan" runat="server" type="hidden" class="fr" style="font-size: 13px"><%--<a class="header_nav" href="#"></a>--%><a id="guanLiYuan" runat="server" style="padding-right: 13%;" onclick="top.location.href='Myadmin/HouTai/YongHuGuanli.aspx'"  >管理员后台</a><a class="header_nav" onclick="top.location.href='Myadmin/changepassword.aspx'" style="font-size: 13px">修改密码</a>　　　<a href="#" onclick="top.location.href='/Myadmin/login.aspx'">退出登录</a> </span>
            ...
            <%--                <span id="HouTai"  type="hidden" class ="fr" >后台登录</span>--%>
            </div>
        </div>
    </form>
</body>
