            ...
            $("#dj_yh").click(function () {
                ...
                var insertStr = "<tr id='del_row" + row + "' >"
                        ...
                        + "</select></td>"
                               ...
                               + "<td class='bg_bj_sj'><input type='text' style='width:147px;margin:1px' onchange='js_xx2(" + (rowLength - 1) + ")' id='ck_dj" + (rowLength - 1) + "' class='input_tr' name='cpsj" + row + "' ></input></td>"
                               + "<td class='bg_bj_sl'><input type='text' style='width:147px;margin:1px' onchange='js_xx2(" + (rowLength - 1) + ")'  id='ck_sl" + (rowLength - 1) + "' class='input_tr' name='cpsl" + row + "' ></input></td>"
                               + "<td  id='dj_js" + (rowLength - 1) + "' style='width:147px;margin:1px'></td>"
            ...
            <table cellspacing="0" cellpadding="0" id="biao_ge" name="bg_row" style="margin-top: 8%;">
                ...
                <tr id="del_row_cs<%=i%>">
                    ...
                    <td class="bg_bj" style="width: 147px; margin: 1px;" onclick="js_xx(<%=i%>)" id="dj_js<%=i%>">
                        <%
                            if(qi_chu_select[i].Cpsj!=null && qi_chu_select[i].Cpsl!=null){
                        %><%=Convert.ToInt32(qi_chu_select[i].Cpsj) * Convert.ToInt32(qi_chu_select[i].Cpsl);
                            }%><% %>
